            ...
            var expected = new List<string>
            {
                "irrelevant, ThingToSetup",
                    "Table [{ PropertyName: SimpleProperty1 of, EndRow: 7, EndColumn: 4, IsRoundTrippable: True },{ PropertyName: SimpleProperty2 of, EndRow: 7, EndColumn: 5, IsRoundTrippable: True }]",
                        "RowDeclaration 0",
                            "Cell(0, 0)",
                                "SimpleProperty1 of, \"SimpleProperty1Value1\", String",
                            "CellFinalisation",
                            "Cell(0, 1)",
                                "SimpleProperty2 of, \"SimpleProperty2Value1\", String",
                            "CellFinalisation",
                        "RowFinalisation",
                        "RowDeclaration 1",
                            "Cell(1, 0)",
                                "SimpleProperty1 of, \"SimpleProperty1Value2\", String",
                            "CellFinalisation",
                            "Cell(1, 1)",
                                "SimpleProperty2 of, \"SimpleProperty2Value2\", String",
                            "CellFinalisation",
                        "RowFinalisation",
                    "TableFinalisation",
            ...
            var expected = new List<string>
            {
                "irrelevant, ThingToSetup",
                    "Table [{ PropertyName: ComplexProperty of, EndRow: 10, EndColumn: 5, IsRoundTrippable: False, SubClassName: ComplexClass, StartRow: 7, FullSubClassName: SpecificationSpecificComplexClass, PropertiesStartColumn: 4, PropertiesEndColumn: 5, Headers: [ {[4, { PropertyName: ComplexProperty1 of, EndRow: 10, EndColumn: 4, IsRoundTrippable: True }]},{[5, { PropertyName: ComplexProperty2 of, EndRow: 10, EndColumn: 5, IsRoundTrippable: True }]} ] },{ PropertyName: SimpleProperty of, EndRow: 7, EndColumn: 6, IsRoundTrippable: True }]",
                        "RowDeclaration 0",
                            "Cell(0, 0)",
                                "ComplexProperty of, ComplexClass",
                                    "Cell(0, 0)",
                                        "ComplexProperty1 of, \"ComplexProperty1Value1\", String",
                                    "CellFinalisation",
                                    "Cell(0, 1)",
                                        "ComplexProperty2 of, \"ComplexProperty2Value1\", String",
                                    "CellFinalisation",
                                "ComplexPropertyFinalisation",
                            "CellFinalisation",
                            "Cell(0, 2)",
                                "SimpleProperty of, \"SimplePropertyValue1\", String",
                            "CellFinalisation",
                        "RowFinalisation",
                        "RowDeclaration 1",
                            "Cell(1, 0)",
                                "ComplexProperty of, ComplexClass",
                                    "Cell(1, 0)",
                                        "ComplexProperty1 of, \"ComplexProperty1Value2\", String",
                                    "CellFinalisation",
                                    "Cell(1, 1)",
                                        "ComplexProperty2 of, \"ComplexProperty2Value2\", String",
                                    "CellFinalisation",
                                "ComplexPropertyFinalisation",
                            "CellFinalisation",
                            "Cell(1, 2)",
                                "SimpleProperty of, \"SimplePropertyValue2\", String",
                            "CellFinalisation",
                        "RowFinalisation",
                    "TableFinalisation",
                "ComplexPropertyFinalisation"
