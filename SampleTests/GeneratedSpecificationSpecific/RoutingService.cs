...
namespace SampleTests.GeneratedSpecificationSpecific
{
    ...
    // If the custom class filename is the same as this one (SpecificationSpecificRoutingService),
    // then it will be used instead of this function. If it is called something else,
    // say SpecificationSpecificRoutingServicePartial, then this class will remain, and
