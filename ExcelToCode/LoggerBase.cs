...
{exception}");
        ...
        public void LogCsprojSaveError(string csprojFilename, Exception exception) =>
            LogError(
$@"Error: Project '{csprojFilename}' could not be saved.
This filename comes from the '/assembliesUnderTest' command line parameter.
The error returned is:
{exception}");

        public void LogExcelFileLoadError(string excelFilename, Exception exception) =>
            LogError(
$@"Error: Excel workbook '{excelFilename}' could not be loaded.
The framework will attempt to load <folder>\ExcelTests\*.xlsx and *.xlsm
<folder> comes from the '/folder' command line parameter.
The error returned is:
{exception}");

        public void LogFileSaveError(string csprojFilename, Exception exception) =>
            LogError(
$@"Error: File '{csprojFilename}' could not be saved.
This file and (convention based) filename is generated by the framework.
The error returned is:
{exception}");
